    ...
    <div class="container items-center px-5 py-12 lg:px-20">
        ...
        <form action="{{ route('posts.update', $post) }}" method="post" enctype="multipart/form-data"
            ...
            <div class="flex items-center w-full pt-4">
                    <x-button 
                    style="display: block !important;" class="w-full py-3 text-base text-white transition duration-500 ease-in-out transform bg-blue-600 border-blue-600 rounded-md focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:bg-blue-800">
                        Modifier mon post
                    </x-button>
            </div>
        </form>
